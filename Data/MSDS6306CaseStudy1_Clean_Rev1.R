...
#################################################
# STEP 2:  CLEAN DATA SET -->  GDPcountryData   #
#################################################
...
# define the variable
# for the column first before you can subset and coerce the variable.)
...
# Step 2D:  GDPcountryData:  Remove first 5 lines of data and rows after 
# observation 195 because these rows do not have country GDP data.  Also,
# these rows have regional GDP data or notes that are not relevant to the 
# analysis. 
...
View(GDPcountryDataClean)


#################################################
# STEP 3:  CLEAN DATA SET --> EducationData     # 
#################################################
...
#Step 3D:  Before, Merging DataSets, Give DataSet New Name to Indicate They 
# Have Been Cleaned.
EducationDataClean <- EducationData
View(EducationDataClean)
